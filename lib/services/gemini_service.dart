...
class GeminiService {
  ...
  static String get _modelName => dotenv.env['GEMINI_MODEL'] ?? 'gemini-1.5-flash';
  ...
  Future<String> generateResponseWithContext(
    ...
    try {
      ...
      if (recentHistory.isNotEmpty) {
        String contextMessage = 'Recent conversation:\n${recentHistory.join('\n')}\n\nCurrent question: $newMessage';
  ...
  bool get isConfigured => _apiKey.isNotEmpty && _apiKey != 'your_actual_api_key_here';
  ...
  Map<String, dynamic> get serviceStatus => {
    ...
    'hasValidKey': _apiKey.isNotEmpty && _apiKey.length > 20,
  };
}