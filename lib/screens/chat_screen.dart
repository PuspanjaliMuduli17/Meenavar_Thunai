...
class _ChatScreenState extends State<ChatScreen> with TickerProviderStateMixin {
        ...
        Consumer<ChatProvider>(
          builder: (context, chatProvider, child) {
            return PopupMenuButton<String>(
              onSelected: (value) => _handleMenuAction(context, value, chatProvider),
              itemBuilder: (context) => [
                const PopupMenuItem(
                  value: 'clear',
                  child: Row(
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return Padding(
              ...
              child: MessageBubble(
                message: message,
                onDelete: () => _deleteMessage(context, chatProvider, message.id),
                onCopy: () => _copyMessage(message.content),
                onRetry: message.isErrorMessage 
  ...
  void _handleMenuAction(BuildContext context, String action, ChatProvider chatProvider) {
    switch (action) {
      case 'clear':
  ...
  void _showServiceStatusDialog(BuildContext context, ChatProvider chatProvider) {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            _buildStatusRow('Configured', status['configured'] ? '✅ Yes' : '❌ No'),
            _buildStatusRow('Model', status['model']),
            _buildStatusRow('API Key', status['hasValidKey'] ? '✅ Valid' : '❌ Invalid'),
  ...
  void _deleteMessage(BuildContext context, ChatProvider chatProvider, String messageId) {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
